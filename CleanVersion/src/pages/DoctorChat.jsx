...
const DoctorChat = () => {
  ...
  const handleSendMessage = (e) => {
    ...
    if (inputMessage.trim()) {
      ...
      // Get next doctor's message if available
        ...
        {messages.map((message, index) => (
          <div key={index} className={`message ${message.type}`}>
            ...
            <div className="message-content">
              ...
              {message.reaction && (
                <div className="message-reaction active">
                  {message.reaction === '👍' && <FaThumbsUp />}
                  {message.reaction === '👎' && <FaThumbsDown />}
                </div>
              )}
            </div>
          </div>
